...
function Team(props: any): ReactJSXElement {
    ...
    return (
        ...
        <div className="sliderbar_header flex flex-col w-full pb-1">
            <NavLink to={`/team/${teamId}`} className='relative group flex justify-start pt-1 pb-1 pl-3 pr-2 items-center align-middle text-[12.5px] font-medium leading-6 cursor-pointer hover:bg-[var(--hover-color)]'>
                <PeopleIcon className='bodyIcon' />
                <h1 className='pl-3'>{teamName || <Skeleton />}</h1>
