...
function Project(props: any): ReactJSXElement {
    ...
    return (
        <div className="sliderbar_header flex flex-col w-full pb-1">
            ...
            !(toggleProject)
            ?
             <Link onClick={hanldeToggleProject} to={`/timeline/${projectId}`} className='relative group/item group/icon flex justify-start pb-[2px] pl-3 pr-2 items-center align-middle text-[12.5px] font-medium leading-6 cursor-pointer hover:bg-[var(--hover-color)]'>
