        ...
        <section className="relative flex h-full  flex-col items-center justify-between bg-gray-500 text-white w-12">
            <div>
                <div className='relative items-center flex flex-col w-8 mt-1'>
                    <Link to="/" className="items-center flex h-8 justify-center mb-[9px] w-8 bg-gray-900 rounded-full transition-transform transform duration-200 hover:scale-[1.2] ease-in-out">
                        <WorkspacesIcon/>
                    </Link>
                </div>
                <div className="group items-center flex flex-col w-8 mb-[9px]">
                    <NavLink to="/news" className="items-center flex h-8 justify-center  w-8 hover:bg-gray-700 hover:rounded-lg">
                        <SettingsIcon/>
                    </NavLink>
                ...
                <div className="group items-center flex flex-col w-8 mb-[9px]">
                    <NavLink to="/a" className="items-center flex h-8 justify-center w-8 hover:bg-gray-700 hover:rounded-lg">
                        <PeopleIcon/>
                    </NavLink>
                    <span className="pointer-events-none after:translate-x-[0.5px] group-hover:opacity-100 z-[9999999] transition-opacity bg-gray-800 px-2 text-sm text-gray-100 rounded-md absolute left-1/4 
                ...
                <div className="group items-center flex flex-col w-8 mb-[9px]">
                    <NavLink to="/b" className="items-center flex h-8 justify-center w-8 hover:bg-gray-700 hover:rounded-lg">
                        <HelpIcon/>
                    </NavLink>
                    <span className="pointer-events-none after:translate-x-[0.5px] group-hover:opacity-100 z-[9999999] transition-opacity bg-gray-800 px-2 text-sm text-gray-100 rounded-md absolute left-1/4 
