        ...
        <div className='Sidebar_wrapper h-full overflow-hidden duration-500 ease-in-out transform'>
            <section className={`overflow-hidden flex h-full flex-col items-center justify-between bg-[var(--second-sliderbar)] text-[var(--white-text)] transition-all ${(isToggle) ? "w-0" : "w-60"}`}>
                ...
                <div className='scrollbar flex flex-col w-full h-full pt-3 pb-1'>
                    ...
                    <div className="sliderbar_header">
                        <NavLink to="/setting/app" className='flex justify-start mb-6 pt-1 pb-1 pl-3 pr-2 items-center align-middle text-[13px] font-[450] leading-6 cursor-pointer hover:bg-[var(--hover-color)]'>
                            <IntegrationInstructionsIcon className='bodyIcon' />
                            <h1 className='pl-3'>Apps & integrations</h1>
                        </NavLink>
                    </div>
                    <div className="sliderbar_header">
                        <NavLink to="/setting/2fa" className='flex justify-start mb-6 pt-1 pb-1 pl-3 pr-2 items-center align-middle text-[13px] font-[450] leading-6 cursor-pointer hover:bg-[var(--hover-color)]'>
                            <LockIcon className='bodyIcon' />
                            <h1 className='pl-3'>Two Factor Authentication</h1>
                        </NavLink>
                    </div>
                    <div className="sliderbar_header">
                        <NavLink to="/setting/shortcut" className='flex justify-start mb-6 pt-1 pb-1 pl-3 pr-2 items-center align-middle text-[13px] font-[450] leading-6 cursor-pointer hover:bg-[var(--hover-color)]'>
                            <HelpIcon className='bodyIcon' />
